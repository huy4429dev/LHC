#pragma checksum "E:\project\c#\LHC2\LHC\Views\Admin\Report\CustomerReport.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c9afb0c6e29b27a9176b96c4b46bceaf51102c67"
// <auto-generated/>
...
#nullable disable
#nullable restore
#line 1 "E:\project\c#\LHC2\LHC\Views\Admin\Report\CustomerReport.cshtml"
...
#nullable disable
#nullable restore
#line 2 "E:\project\c#\LHC2\LHC\Views\Admin\Report\CustomerReport.cshtml"
using DVN.ViewModels;

#line default
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c9afb0c6e29b27a9176b96c4b46bceaf51102c67", @"/Views/Admin/Report/CustomerReport.cshtml")]
    ...
    public class Views_Admin_Report_CustomerReport : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 3 "E:\project\c#\LHC2\LHC\Views\Admin\Report\CustomerReport.cshtml"
      ...
      <table class=""table"">
        <thead>
            <tr>
                ...
                <th class=""text-center"">Khách hàng mới</th>
                <th class=""text-center"">Khách hà");
            WriteLiteral(@"ng cũ</th>
                <th class=""text-center"">Khách hàng</th>
                <th class=""text-center"">Tổng hóa đơn</th>
                <th class=""text-center"">Tỷ lệ khách hàng mới sử dụng điện (%)</th>
            </tr>
        </thead>
...
");
    ...
    <script>
    	var fromDate = ");
#nullable restore
#line 79 "E:\project\c#\LHC2\LHC\Views\Admin\Report\CustomerReport.cshtml"
...
#nullable disable
                WriteLiteral(";\r\n\t\tvar toDate = ");
#nullable restore
#line 80 "E:\project\c#\LHC2\LHC\Views\Admin\Report\CustomerReport.cshtml"
                Write(Html.Raw(Json.Serialize("")));
...
#nullable disable
    ...
    <script>
            ...
            const time = document.q");
                WriteLiteral("uerySelector(\'#time\');\r\n            time.innerHTML = \'(\' +  moment(lastMonth).format(\"DD/MM/YYYY\") + \' - \' + moment(curentDate).format(\'DD/MM/YYYY\') + \')\'; \r\n            var data = ");
#nullable restore
#line 105 "E:\project\c#\LHC2\LHC\Views\Admin\Report\CustomerReport.cshtml"
            ...
            const row = (record) => { 
                return  (
                    `<tr class=""text-center"">
                        ...
                        <td>${record.total}</td>
                        <td>${Math.floor(record.total / ((record.totalNewCustomer + record.totalOldCustomer) == 0 ? 1 : (record.totalNewCustomer + record.totalOldCustomer))) * 100}</td>
                    </tr>` )
            };
            ...
            const rowFooterRender = (record) => { 
                return  (
                    `<tr class=""text-center"">
                        ...
                        <td>${record.totalCustomer}</td>
     ");
                WriteLiteral(@"                   <td>${record.total}</td>
                        <td>${Math.floor(record.total / ((record.totalNewCustomer + record.totalOldCustomer) == 0 ? 1 : (record.totalNewCustomer + record.totalOldCustomer))) * 100 / record.length}</td>
                    </tr>` )
            };
         ...
         ");
            ...
            function getDataAjax(start, end , label){
                    ...
                    let productsHTML = '';
                    let timerId = null; 
                    fetch(`${URL}/admin/report/order/ajax?toDa");
                WriteLiteral(@"te=${moment(start).toISOString()}&fromDate=${moment(end).toISOString()}`)
           ...
           ");
                WriteLiteral(@"         let totalNewCustomer = 0;
