#pragma checksum "E:\project\c#\LHC\Views\Admin\Report\CustomerReport.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ab8fa62c25a399e8e7502ff523be0d8cef3063f4"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ab8fa62c25a399e8e7502ff523be0d8cef3063f4", @"/Views/Admin/Report/CustomerReport.cshtml")]
    ...
    <table class=""table"">
        <thead>
            <tr>
                ...
                <th>Tổng hóa đơn</th>
          ");
            WriteLiteral(@"      <th>Tỷ lệ khách hàng quay lại (%)</th>
                <th>Tỷ lệ khách hàng mới sử dụng điện (%)</th>
            </tr>
        </thead>
...
");
    ...
    <script>
    	var fromDate = ");
#nullable restore
#line 77 "E:\project\c#\LHC\Views\Admin\Report\CustomerReport.cshtml"
...
#nullable disable
                WriteLiteral(";\r\n\t\tvar toDate = ");
#nullable restore
#line 78 "E:\project\c#\LHC\Views\Admin\Report\CustomerReport.cshtml"
                Write(Html.Raw(Json.Serialize("")));
...
#nullable restore
#line 103 "E:\project\c#\LHC\Views\Admin\Report\CustomerReport.cshtml"
            ...
            const rowFooterRender = (record) => { 
                return  (
                    `<tr class=""text-center"">
                        <td>Tổng</td>
            ");
                WriteLiteral(@"            <td>${record.totalNewCustomer}</td>
                        <td>${record.totalOldCustomer}</td>
                        <td>${record.totalCustomer}</td>
                        <td>${record.total}</td>
...
");
            ...
            const listDa");
                WriteLiteral(@"tes = enumerateDaysBetweenDates(lastMonth, curentDate).map(item => moment(item).format(""DD/MM/YYYY""));
            ...
            r");
                WriteLiteral(@"enderDataTable(data);
