#pragma checksum "E:\project\c#\LHC2\LHC\Views\Admin\Report\Revenue.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a88f56a31d607cdd1524582a776745d554ab5e7b"
// <auto-generated/>
...
#nullable disable
#nullable restore
#line 1 "E:\project\c#\LHC2\LHC\Views\Admin\Report\Revenue.cshtml"
...
#nullable disable
#nullable restore
#line 2 "E:\project\c#\LHC2\LHC\Views\Admin\Report\Revenue.cshtml"
using DVN.ViewModels;

#line default
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a88f56a31d607cdd1524582a776745d554ab5e7b", @"/Views/Admin/Report/Revenue.cshtml")]
    ...
    public class Views_Admin_Report_Revenue : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 3 "E:\project\c#\LHC2\LHC\Views\Admin\Report\Revenue.cshtml"
  
    Layout = "_LayoutAdmin";
    ViewBag.Title = "LƯỢT ";
    ViewBag.PageName = "BÁO CÁO DOANH THU BÁN PIN";
...
#nullable disable
#nullable restore
#line 9 "E:\project\c#\LHC2\LHC\Views\Admin\Report\Revenue.cshtml"
...
<div class=""d-flex justify-content-end"">
    <div>
        <div class=""form-group mt-3"">
            <div class=""d-flex"">
                <a href=""/admin/report/revenue/excel"" class=""btn btn-success mr-1""><i class=""far fa-file-excel""></i></a>
...
<div class=""row mt-4"">
    <div class=""col-12"">
        <h5 class=""text-center mb-5"" style=""font-weight:400;font-size:20px; color: #414141"">
            Biểu đồ thống kê doanh thu bán pin <br />
            <small id=""time""></small> 
        </h5>
...
<div class=""row mt-4"">
    ...
    <script>
		...
		var fromDate = ");
#nullable restore
#line 81 "E:\project\c#\LHC2\LHC\Views\Admin\Report\Revenue.cshtml"
...
#nullable disable
                WriteLiteral(";\r\n\t\tvar toDate = ");
#nullable restore
#line 82 "E:\project\c#\LHC2\LHC\Views\Admin\Report\Revenue.cshtml"
                Write(Html.Raw(Json.Serialize("")));
...
#nullable restore
#line 108 "E:\project\c#\LHC2\LHC\Views\Admin\Report\Revenue.cshtml"
            ...
            const row = (record) => { 
                return  (
                    `<tr class=""text-center"">
                        ...
                        <td>${record.total}</td>
                        <td>${record.totalOrdrerSuccess.toLocaleString('it-IT', {style : 'currency', currency : 'VND'})}</td>
...
");
            ...
            function getDataAjax(start, end , label){
                    ...
                    let productsHTML = '';
                    let timerId = null; 
                    fetch(`${URL}/admin/report/revenue/ajax?toDate=${moment(start).toISOString()}&fromDate=${moment(end).toISOString()}`)
                    .then(response => response.json())
                    .then(data => {
                        timerId = setInterval(() => {
                                loading.style.display = 'none';
                                let listDates = enumerateDaysBetweenDates(moment(start).add(-1,'d'),moment(end).add(1,)).");
                WriteLiteral(@"map(item => moment(item).format(""DD/MM/YYYY""));
                ...
                WriteLiteral(@"
                    ...
                    tooltip: {
                        ...
                        pointFormat: '<tr><td style=""color:{series.color};padding:0"">{series.name}: </td>' +
                            '<td style=""padding:0""><b>{point.y}</b> vnđ</td></tr>',
                        footerFormat: '</table>',
                        shared: true,
                        useHTML: true
                    },
